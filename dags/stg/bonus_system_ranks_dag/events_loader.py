...
class EventDestRepository:
    ...
    def insert_event(self, conn: Connection, outbox: EventObj) -> None:
...
class EventLoader:
    WF_KEY = "stg_bonussystem_events_workflow"
    LAST_LOADED_ID_KEY = "last_loaded_id"
    BATCH_LIMIT = 10000  # Загружаем пачками
    ...
    def load_events(self):
        ...
        with self.pg_dest.connection() as conn:
            ...
            for event in load_queue:
                print(111111111111111111111111111111111111111111111111111111111111111111111111, event)
